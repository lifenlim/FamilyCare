...
const en: Dictionary = {
  ...
  login: {
    title: "FamilyCare",
    subtitle: "Sign in below — no password needed.",
    emailTab: "Email",
    phoneTab: "WhatsApp",
    ...
    codeSentMessage: "We sent a code to your WhatsApp. Enter it below to sign in.",
    codeLabel: "6-digit code",
    codePlaceholder: "123456",
    verifyCodeButton: "Verify and sign in",
  ...
  invite: {
    ...
    invitedToPatient: (patientName, circleName) =>
      `You are invited to join ${patientName} in ${circleName}`,
    roleLabel: "Role:",
