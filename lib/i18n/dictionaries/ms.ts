...
const ms: Dictionary = {
  ...
  members: {
    ...
    roleAccountOwner: "Pemilik Akaun",
    roleCaretaker: "Penjaga Utama/Kedua",
    ...
    familyMemberHint: "Hanya boleh melihat senarai jagaan",
    careTakerHint: "Boleh melihat dan menyunting senarai jagaan",
  ...
  activity: {
    ...
    someone: "Seseorang",
    actions: {
      viewedCareList: "melihat senarai jagaan",
